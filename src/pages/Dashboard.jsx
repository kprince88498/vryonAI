    ...
    <div className="min-h-screen bg-[#02050E] text-white flex flex-col font-sans relative overflow-hidden select-none">
            ...
            <svg className="w-full h-full filter drop-shadow-[0_10px_35px_rgba(0,210,255,0.45)]" viewBox="0 0 100 100" fill="none">
              ...
              <defs>
                <linearGradient id="main-v-3d" x1="12" y1="15" x2="88" y2="85" gradientUnits="userSpaceOnUse">
                  ...
                  <stop offset="75%" stopColor="#6e00ff" />
      ...
      <div className="p-4 mb-2 z-10 bg-transparent">
        <div className="max-w-md mx-auto bg-[#040918]/80 border-[1.5px] border-[#0052ff]/40 rounded-[32px] p-2 flex items-center justify-between gap-2 shadow-[0_0_40px_rgba(0,82,255,0.25)] backdrop-blur-xl relative group">
          <button title="Upload File" className="w-[42px] h-[42px] rounded-full bg-[#0c162e]/90 border border-slate-800/80 flex items-center justify-center text-gray-300">
          ...
          <div className="flex items-center gap-1.5 pr-0.5">
            <button 
              ...
              className={`w-9 h-9 rounded-full flex items-center justify-center transition-all ${isListening ? 'bg-red-500/20 text-red-400 border border-red-500/30' : 'text-gray-300'}`}
            >
            ...
            <button className="w-9 h-9 rounded-full flex items-center justify-center text-[#00d2ff] bg-[#00d2ff]/10">
            ...
            <button className="w-[42px] h-[42px] rounded-full bg-gradient-to-b from-[#00d2ff] to-[#0052ff] flex items-center justify-center text-white shadow-[0_4px_14px_rgba(0,210,255,0.4)]">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
